...
public interface NoticeMapper {
    ...
    void insertNotice(@Param("memberId") Long memberId, @Param("notice") NoticeDto noticeDto);
    void insertBatchNotice(@Param("memberId") Long memberId, @Param("notices") List<NoticeDto> noticeList);
